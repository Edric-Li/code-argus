...
export const VALIDATION_PROMPT_CONFIGS: Record<IssueCategory, ValidationPromptConfig> = {
  ...
  performance: {
    ...
    validationFocus: [
      ...
      'Check if caching mechanisms exist',
      'Confirm data scale assumptions are reasonable',
      'Verify if code is on a hot path',
    ],
    rejectionCriteria: [
      'Code is rarely executed (cold path)',
      'Caching already exists',
      'Data scale is too small for optimization to matter',
